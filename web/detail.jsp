<%-- 
    Document   : detail
    Created on : Dec 16, 2019, 11:14:10 PM
                                ...
                                <div class="col-sm-7">
                                    <div class="product-information"><!--/product-information-->
                                        ...
                                        <span>
                                            ...
                                            <p><a  class="btn btn-fefault cart" href="GioHangServlet?command=plus&ma_san_pham=<%=sp.getMa_san_pham()%>&cartID=<%=System.currentTimeMillis()%>">
                                                <i class="fa fa-shopping-cart" ></i>
                                                Thêm vào giỏ hàng
                                                </a></p>
                                        <p><b>Số lượng: </b><%=sp.getSo_luong()%> sản phẩm</p>
