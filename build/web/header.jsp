<%-- 
    Document   : header
    Created on : Dec 16, 2019, 10:31:15 PM
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +84 932506406</a></li>
                                    <li><a href="#"><i class="fa fa-envelope"></i> nguyenvangiabao99@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="#"><i class="fa fa-star"></i> Ưa Thích</a></li>
